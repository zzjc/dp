...
<a href="<?php echo U('prize/add');?>"><button class="layui-btn"><i class="layui-icon">&#xe608;</i> 添加奖品</button></a>
</div>
...
<th width="20%" align="center">奖品名称</th>
<th width="10%" align="center">图片</th>
<th width="10%" align="center">中奖概率%</th>
<th width="10%" align="center">每月库存</th>
